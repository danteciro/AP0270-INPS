 ...
 * @author jpiro
 */
public class ExpedienteGSMBuilder {
    public static List<ExpedienteGSMDTO> toListExpedienteDto(List<PghExpediente> lista) {
    	ExpedienteGSMDTO registroDTO;
        List<ExpedienteGSMDTO> retorno = new ArrayList<ExpedienteGSMDTO>();
        if (lista != null) {
    ...
    public static ExpedienteGSMDTO toExpedienteDto(PghExpediente registro) {
    	ExpedienteGSMDTO registroDTO = new ExpedienteGSMDTO();
        ...
        if(registro!=null){
            ...
            if (registro.getIdEstadoLevantamiento() != null) {
                if (registro.getIdEstadoLevantamiento().getIdMaestroColumna() != null) {
                    registroDTO.setEstadoLevantamiento(new MaestroColumnaDTO(registro.getIdEstadoLevantamiento().getIdMaestroColumna()));
                }
            }
	        ...
	        if(registro.getIdDmUnidadSupervisada()!=null){
	        	DmUnidadSupervisadaDTO unidadSupervisadaGSMDTO=new DmUnidadSupervisadaDTO();
	        	unidadSupervisadaGSMDTO.setIdDmUnidadSupervisada(registro.getIdDmUnidadSupervisada().getIdDmUnidadSupervisada());
	        	unidadSupervisadaGSMDTO.setCodigoUnidadSupervisada(registro.getIdDmUnidadSupervisada().getCodigoUnidadSupervisada());
	        	unidadSupervisadaGSMDTO.setNombreUnidadSupervisada(registro.getIdDmUnidadSupervisada().getNombreUnidadSupervisada());
	            if(registro.getIdDmUnidadSupervisada().getIdActividad()!=null){
	                ActividadDTO actividadDTO=new ActividadDTO();
	                actividadDTO.setNombre(registro.getIdDmUnidadSupervisada().getIdActividad().getNombre());
	                actividadDTO.setIdActividad(registro.getIdDmUnidadSupervisada().getIdActividad().getIdActividad());
	                registroDTO.setActividad(actividadDTO);
	            } 
	            if(registro.getIdDmUnidadSupervisada().getIdEstrato()!=null){
	            	MaestroColumnaDTO estratoDTO = new MaestroColumnaDTO();
	            	estratoDTO.setIdMaestroColumna(registro.getIdDmUnidadSupervisada().getIdEstrato().getIdMaestroColumna());
	            	estratoDTO.setDescripcion(registro.getIdDmUnidadSupervisada().getIdEstrato().getDescripcion());
	            	unidadSupervisadaGSMDTO.setIdEstrato(estratoDTO);
	            }
	            if(registro.getIdDmUnidadSupervisada().getIdTipoMinado()!=null){
	            	MaestroColumnaDTO tipoMinadoDTO = new MaestroColumnaDTO();
	            	tipoMinadoDTO.setIdMaestroColumna(registro.getIdDmUnidadSupervisada().getIdTipoMinado().getIdMaestroColumna());
	            	tipoMinadoDTO.setDescripcion(registro.getIdDmUnidadSupervisada().getIdTipoMinado().getDescripcion());
	            	unidadSupervisadaGSMDTO.setIdTipoMinado(tipoMinadoDTO);
	            }
	            registroDTO.setUnidadSupervisadaGSM(unidadSupervisadaGSMDTO);
	        }
	        
	        if(registro.getIdTitularMinero()!=null){
	        	DmTitularMineroDTO titularMineroDTO = new DmTitularMineroDTO();
	        	titularMineroDTO.setIdTitularMinero(registro.getIdTitularMinero().getIdTitularMinero());
	        	titularMineroDTO.setNombreTitularMinero(registro.getIdTitularMinero().getNombreTitularMinero());
	        	titularMineroDTO.setCodigoTitularMinero(registro.getIdTitularMinero().getCodigoTitularMinero());
	        	registroDTO.setTitularMinero(titularMineroDTO);
	        }
	        /* OSINE_SFS-791 - RSIS 33 - Inicio */ 
    ...
    public static PghExpediente toExpedienteDomain(ExpedienteGSMDTO registroDTO) {
