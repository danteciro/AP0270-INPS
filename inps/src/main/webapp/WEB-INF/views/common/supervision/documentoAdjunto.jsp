        		...
        		<c:if test="${modo ne 'VER'}">
	        		<form id="formDocumentoAdjuntoSuper" action="/inps/pages/archivo/subirPghDocumentoAdjunto" method="post" enctype="multipart/form-data" encoding="multipart/form-data" >
			      	<div class="filaForm tac">
			             ...
			             <div>
			                 <input type="text" id="txtDescripcionDASuper" validate="[O]" name="descripcionDocumento" maxlength="200" style="text-transform: none !important;" class="ipt-medium-small" value="" />
			             </div>
			        </div>
			        <div class="filaForm tac">
