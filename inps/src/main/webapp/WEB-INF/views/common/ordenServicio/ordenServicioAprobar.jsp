            ...
            <form>
                ...
                <div class="pui-subpanel ui-widget-content">
                    ...
                    <div class="pui-subpanel-content">
	                    ...
	                    <div>
	                        <input id="txtAsuntoSigedOSApr" type="text" maxlength="500" class="ipt-medium-small-medium-small-medium" value="${r.asuntoSiged}" disabled />
	                    </div>                          	
                        </div>                        
                ...
                <div class="pui-subpanel ui-widget-content">
                    ...
                    <div class="pui-subpanel-content">
                        <div class="filaForm">
                            ...
                            <div class="vam">
                                <select id="slctUnidSupeOSApr" class="slct-medium-small-medium" disabled > 
                        ...
                        <div>                        	                     	
                            <div class="filaForm">
                                ...
                                <div class="vam">
                                    <input id="txtRubroOSApr" type="text" validate="[O]" class="ipt-medium-small-medium" disabled />
                                </div>
                            </div>
                            <div class="filaForm">
                                <div class="lbl-small vam"><label for="">Dirección Operativa:</label></div>
                                <div class="vam">
                                    	<input id="txtIdDepartamentoOSApr" type="hidden" />  
                                	<input id="txtIdProvinciaOSApr" type="hidden" /> 
                                	<input id="txtIdDistritoOSApr" type="hidden" /> 
                                        <input id="txtDireOperOSApr" type="text" class="ipt-medium-small-medium-small-medium" disabled /> 
                                </div>
                            </div>
                            <div class="filaForm">
                                <div class="lbl-small vam"><label>Tipo/Nro Documento:</label></div>
                                <div class="vam">
                                    <input name="" type="text" validate="[O]" class="ipt-medium-small" value="RUC - ${r.unidadSupervisada.ruc}" disabled />
                                </div>
                            </div>
                            <div class="filaForm">
