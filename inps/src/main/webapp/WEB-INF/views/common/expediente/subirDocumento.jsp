    ...
    <body>
        <form id="formSubirDocuOS" action="/inps/pages/archivo/subirPghDocuAdjuntoOS" method="post" enctype="multipart/form-data" encoding="multipart/form-data">
            <div class="form">
                ...
                <input type="hidden" name="idDirccionUnidadSuprvisada" validate="[O]" value="${idDirccionUnidadSuprvisada}">
                <input type="hidden" name="idUnidadSupervisada.idUnidadSupervisada" validate="[O]" value="${idUnidadSupervisada}">
                <!-- htorress - RSIS 8 - Fin -->
                <div class="filaForm">
                ...
                <div class="filaForm">
                    ...
                    <div>
                        ...
                        <!-- <input type="text" id="txtDescDocuSubirDocuOS" name="descripcionDocumento" style="text-transform: none !important;" maxlength="25" class="ipt-medium-small" validate="[O]"/> -->
                        <input type="text" id="txtDescDocuSubirDocuOS" name="descripcionDocumento" style="text-transform: none !important;" maxlength="100" class="ipt-medium-small" validate="[O]"/>
                        <!-- OSINE_MAN-004 - Fin -->
                    </div>
                </div>
                <div class="filaForm">
