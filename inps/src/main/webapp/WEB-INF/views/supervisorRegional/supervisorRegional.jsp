<%--
* Resumen		
* Objeto		: supervisorRegional.jsp
* Descripción		: supervisorRegional
* Fecha de Creación	: 25/03/2016
* PR de Creación	: OSINE_SFS-480
* Autor			: Hernán Torres Saenz
* =====================================================================================================================================================================
* Modificaciones |
...
<t:template pageTitle="ADMINISTRACION DE EXPEDIENTES" scrollPanelTitle="">
    <jsp:attribute name="headArea">
        <script type="text/javascript" src='<c:url value="/javascript/app/supervisorRegional/supervisorRegional.js" />' charset="utf-8"></script>
    ...
    <jsp:attribute name="bodyArea">
        <div class="container pui-panel ui-widget-content">
            ...
            <div class="pui-panel-content">
                ...
                <div id="tabsSupervisorRevional" style="position:relative;">
                    <ul>
                        <c:forEach items="${listadoOpcionSupervisorRegional}" var="t">
