...
<t:template pageTitle="ADMINISTRACION DE EXPEDIENTES" scrollPanelTitle="">
    <jsp:attribute name="headArea">
        <script type="text/javascript" src='<c:url value="/javascript/app/supervisor/supervisor.js" />' charset="utf-8"></script>
            ...
            <div class="pui-panel-content">
                <div class="form form-large">
                    <div class="filaForm">
                        ...
                        <div class="filaForm">
                            <div class="lbl-medium"><label class="fwb">Empresa Supervisora:</label></div>
                            <div>
