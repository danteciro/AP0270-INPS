...
<html>
    <head>
        <script type="text/javascript"
            src='<c:url value="/javascript/app/jefe/notificadoArchivado/notificadoArchivado.js" />' charset="utf-8">
        </script>	
    </head>
    <body>
        ...
        <div class="tal">
            <input type="button" id="btnConsultarMensajeriaJefe" class="btn-azul btn-medium" value="Consultar Mensajeria">
        </div>
