            ...
            <form id="frmOS">
                ...
                <div class="pui-subpanel ui-widget-content">
                    ...
                    <div class="pui-subpanel-content">
	                    ...
	                    <div>
	                        <input id="txtAsuntoSigedOS" type="text" maxlength="1000" class="ipt-medium-small-medium-small-medium" value="${r.asuntoSiged}" <c:if test="${(tipo!='asignar' && tipo!='generar' && tipo!='editar') || (tipo=='asignar' && r.iteracionExpediente>0) || r.flagMuestral=='1'}">disabled</c:if> />
	                    </div>                          	
                        </div>                        
                ...
                <div class="pui-subpanel ui-widget-content">
                    ...
                    <div class="pui-subpanel-content">
                        ...
                        <div class="filaForm" <c:if test="${(tipo=='editar')}">style="display:none;"</c:if>>
                            ...
                            <c:if test="${tipo=='asignar' && (r.iteracionExpediente==null || r.iteracionExpediente==0)}">    
...
<!--                                	<input id="txtIdActividadOS" type="hidden" />   OSINE_SFS-480 - RSIS11 - Inicio     -->
                            ...
                            <div class="filaForm">
                                ...
                                <div class="vam">
                                    <input id="nroDocumentoOS" name="" type="text" validate="[O]" class="ipt-medium-small" value="<c:choose><c:when test="${r.empresaSupervisada.ruc!='' && r.empresaSupervisada.ruc!=null}">RUC - ${r.empresaSupervisada.ruc}</c:when><c:otherwise>${r.empresaSupervisada.tipoDocumentoIdentidad.descripcion} - ${r.empresaSupervisada.nroIdentificacion}</c:otherwise></c:choose>" disabled />
                                </div>
                            </div>
                            <div class="filaForm">
                                <div class="lbl-small vam"><label for="">Razón Social:</label></div>
                                <div class="vam">
                                    <input id="razonSocialOS" type="text" class="ipt-medium-small-medium-small-medium" value="${r.empresaSupervisada.razonSocial}" disabled />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pui-subpanel ui-widget-content">
                    ...
                    <c:if test="${tipo=='editar' || tipo=='asignar'}">
                    	<div id="txtObligatorioUnidadOrganicaOS" class="txt-obligatorio"></div>
                    </c:if>                    
                </div>
                </c:if>
                <!-- OSINE_SFS-480 - RSIS 42 - Inicio -->
