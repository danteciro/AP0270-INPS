                ...
                <div class="filaForm tac">
                    <div class="lbl-medium vam">
                        ...
                        <label for="radioSiSupervision" class="radio">Si</label>
                            -->
                            <input id="radioSiSupervision" type="radio" name="radioSupervision" value="1" 
                            <c:if test="${sup.flagSupervision=='1'}">checked="checked"</c:if> <c:if test="${sup.idSupervision=='' || sup.idSupervision==null}">disabled</c:if>
                            <c:if test="${modo=='consulta'||sup.ordenServicioDTO.iteracion==2}">disabled</c:if>>
                        ...
                        <c:if test="${modo=='consulta'||sup.ordenServicioDTO.iteracion==2}">disabled</c:if>>
                            -->
                            <input id="radioNoSupervision" type="radio" name="radioSupervision" value="0" 
                            <c:if test="${sup.flagSupervision=='0'}">checked="checked"</c:if> <c:if test="${sup.idSupervision=='' || sup.idSupervision==null}">disabled</c:if>
                            <c:if test="${modo=='consulta'||sup.ordenServicioDTO.iteracion==2}">disabled</c:if>>
                            <!-- OSINE_SFS-480 - RSIS 13 - Fin -->
                    ...
                    <fieldset id="fldstSuperAnterior">
                        ...
                        <div class="form" id="divFrmDatosSuperAnt">
                            ...
                            <div class="filaForm">
                                ...
                                <div class="lbl-small vam"><label>N° carta de visita:</label></div>
                                <div class="vam">
                ...
                <fieldset id="fldstDatosSuper">
                    ...
                    <div class="form" id="divFrmDatosSuper">
                        ...
                        <div class="filaForm">
                            ...
                            <div class="filaForm">
                                ...
                                <div class="vam">
                                    <textarea class="ipt-medium-small-medium-small-medium" rows="4" id="txtObservacionRS" maxlength="4000" <c:if test="${modo=='consulta'}">disabled</c:if>>${sup.observacion}</textarea>
                                </div>
                            </div>
                    ...
                    <fieldset id="fldstPersonaAtiende" <c:if test="${sup.idSupervision=='' || sup.idSupervision==null}">disabled</c:if>>
                        ...
                        <div class="filaForm">
                            ...
                            <div class="vam">
                                <textarea class="ipt-medium-small-medium-small-medium" rows="4" id="txtObservacionPersonaAtiendeRS" maxlength="4000" <c:if test="${asignacion!=1 || modo=='consulta'}">disabled</c:if>>${sup.observacionIdentificaPers}</textarea>
                                </div>
                            </div>
                            <div class="botones">
