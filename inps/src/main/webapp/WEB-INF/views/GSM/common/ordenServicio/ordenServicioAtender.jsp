...
* =====================================================================================================================================================================
* OSINE_SFS-1344 |  26/10/2016   |   Giancarlo Villanueva A.    |     Adecuar pantalla INPS para la GSM
*
--%>
...
<html>
    <head>
        <script type="text/javascript" src='<c:url value="/javascript/app/GSM/common/ordenServicio/ordenServicioAtender.js" />' charset="utf-8"></script>
    </head>
    <body>
            ...
            <form>
                ...
                <div class="pui-subpanel ui-widget-content">
                    ...
                    <div class="pui-subpanel-content">
	                    ...
	                    <div>
	                        <input id="txtAsuntoSigedOSAte" type="text" maxlength="1000" class="ipt-medium-small-medium-small-medium" value='${r.asuntoSiged}' disabled />
	                    </div>                          	
                        </div>                        
