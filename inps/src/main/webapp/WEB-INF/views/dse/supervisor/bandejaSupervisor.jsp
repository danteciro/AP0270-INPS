...
<t:template pageTitle="PROCESO RECHAZO CARGA" scrollPanelTitle="">
    <jsp:attribute name="headArea">
        <script type="text/javascript" src='<c:url value="/javascript/app/dse/supervisor/bandejaSupervisor.js" />' charset="utf-8"></script>
    ...
    <jsp:attribute name="bodyArea">
        <div class="container pui-panel ui-widget-content">
          ...
          <div class="pui-panel-content">
 			<div id="tabsSupervisorDse" style="position:relative;">
 				<ul>
                    ...
                    <div id="rechazoCarga">
                        <jsp:include page="../supervisor/rechazoCarga/bandejaRechazoCarga.jsp"/>
                    </div>
                      <div id="tabRegistroActaInspeccion">
                        <jsp:include page="../supervisor/actaInspeccion/actaInspeccion.jsp"/>
                    </div>
                    <div id="tabRegistroInformeSupervision"> 
                         <jsp:include page="../supervisor/informeSupervision/registroInformeSupervision.jsp"/> 
                    </div> 
 			</div>
