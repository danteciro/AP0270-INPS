...
<script type="text/javascript"
	src='<c:url value="/javascript/app/dse/especialista/rechazoCarga/bandejaRechazoCarga.js" />'
	charset="utf-8">
		...
		<form id="frmBandejaRechazoCarga">
			 <div id="divMensajeValidaFrmBandejaRechazoCarga" class="errorMensaje" style="display: none"></div>
				...
				<div class="lbl-small-small vam" ><label>Nro. Expediente:</label></div>
                    <div class="vam">
                        <input id="txtNroExpediente" name="txtNroExpediente" type="text" maxlength="12" class="ipt-medium" value="" />
                    </div>
				</div>
