...
<html>
	<head>
		<script type="text/javascript"
			src='<c:url value="/javascript/app/dse/especialista/informeSupervision/registroInformeSupervision.js" />' charset="utf-8">
		</script>
	</head>
	<body>
	
		<div class="form">
			<form id="frmRegistroActaInspeccion1">
			  
				<div id="divMensajeValidaFrmRegistroActaInspeccion1" class="errorMensaje" style="display: none"></div>
		...
		<div id="dialogActaExpedientesZonaInfSup" class="dialog" style="display:none;"></div>
