...
var coSupeHalla=(function() {
	function constructor() {		
		...
		$('#txtDescripcion').alphanum(constant.valida.alphanum.comentario);
...
//		}
	...
	function validarMedioProbatorio(descripcion,nombreArchivo){
		...
		$.ajax({
            ...
            data: {
            	idDetalleSupervision : $('#idDetalleSupervisionDH').val(),
    			descripcionDocumento : descripcion.toUpperCase(),
...
jQuery.extend($.fn.fmatter, { //mdiosesf - RSIS6
    ...
    comentarioCriterio: function(cellvalue, options, rowdata) {
    	...
    	if (tipoDH==constant.modoSupervision.consulta){html="<p style='text-align:left; font-size:11px;'>"+descripcionResultado+"</p>";}
    		...
    		html = "<input id='comentarioCriterio_"+idCriterio+"' type='text' class='ipt-grid-inps ipt-medium-small' disabled readonly name='comentarioCriterio_"+idCriterio+"' value='"+descripcionResultado+"' onclick='coSupeHalla.ComentarioHallazgoCriterio(this,\""+idCriterio+"\",1)' />";
