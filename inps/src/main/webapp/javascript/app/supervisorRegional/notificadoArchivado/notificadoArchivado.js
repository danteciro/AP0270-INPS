...
* Descripción		: JavaScript donde se maneja las acciones de la pestaña de notificado/ Archivado del Supervisor Regional.
...
//supervisorRegional/notificadoArchivado/notificadoArchivado.js
...
$(function() {
    ...
    $('#btnConsultarMensajeriaSupervisorRegional').click(function(){common.abrirConsultaMensajeriaExpediente();});
