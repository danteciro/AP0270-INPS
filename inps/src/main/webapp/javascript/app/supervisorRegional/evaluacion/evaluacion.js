...
* Descripción		: JavaScript donde se maneja las acciones de la pestaña de evaluaciones del Supervisor Regional.
...
* OSINE_791      |  26/08/2016   |   Gullet Alvites Pisco       |     Habilitar el link linkAprobarExpeEval para el flujo DSR cuando el estado actual sea supervisado y el estado 
*                                                                     Siguiente sea aprobado.
*/

$(function() {
    espeEvalEval.procesarGridEvaluacion();
});
//supervisorRegional/evaluacion/evaluacion.js
var espeEvalEval={
...
//                }else if(row['ordenServicio.estadoProceso.identificadorEstado']==constant.identificadorEstado.osRevisado){
                /* OSINE791 - RSIS 21 - Fin */ 
                	// htorress - RSIS 18 - Inicio
                /* OSINE791 - RSIS 21 - Inicio */
                var link = fxLinkGrilla.habilitarEstados(row['ordenServicio.estadoProceso.identificadorEstado'], row['ordenServicio.osIdentificadorEstadoSgt'],constant.rol.supervisorRegional);
