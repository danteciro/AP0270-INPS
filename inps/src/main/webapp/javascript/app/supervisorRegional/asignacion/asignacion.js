...
* Descripción		: JavaScript donde se maneja las acciones de la pestaña de asignaciones del Supervisor Regional.
...
//supervisorRegional/asignacion/asignacion.js
var espeAsigAsig={
    procesarGridAsignacion:function() {
        var nombres = ['idExpe','flagOrigen','idTramite','idEtapTram','idProcTram','idProceso','idObliTipo','idUnidSupe','C&Oacute;DIGO OSINERGMIN',
            ...
            //'idLoca','nombCompArmaLo','idSupeEmpr','razoSociSE','EMPRESA SUPERVISORA'];
        	'idLoca','nombCompArmaLo','idSupeEmpr','razoSociSE','EMPRESA SUPERVISORA','idPeticion', 'codigoPeticion', 'idMotivo',
            /* OSINE_SFS-480 - RSIS 42 - Fin */
            /* OSINE_SFS-791 - RSIS 34 - Inicio */
            'flagEvaluaTipoAsignacion','comentarioDevolucion','',''];
...
//            {name: "empresaSupervisada.razonSocial", width: 245, sortable: false, align: "left"},
...
//        grid.jqGrid('navGrid','#paginacionAsignacion',{edit:false,add:false,del:false,search:false,view:false,refresh:false});
//        grid.jqGrid('navButtonAdd','#paginacionAsignacion',{caption:"",buttonicon:"ui-icon-search",title:"Buscar Expediente",
//            onClickButton:function(){
//                common.abrirBusquedaExpediente(espeAsigAsig.procesarGridAsignacion,constant.bandeja.espAsignaciones);
//            }
//        });
    }  
};
