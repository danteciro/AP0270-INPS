...
* Descripción		: JavaScript donde se maneja las acciones de la pestaña de notificaciones/ Archivado del Jefe de Unidad ó Regional.
...
//jefe/notificadoArchivado/notificadoArchivado.js
...
$(function() {
    ...
    $('#btnConsultarMensajeriaJefe').click(function(){common.abrirConsultaMensajeriaExpediente();});
