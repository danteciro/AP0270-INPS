...
//            {name: "empresaSupervisada.nroIdentificacion", hidden:true},
        ...
        grid.jqGrid({
            ...
            postData: {
                ...
                fechaInicioOS: $("#txtFechaInicioOS").val(),
                fechaFinOS: $("#txtFechaFinalOS").val(),
                estadoOrden: $("#slctEstadoOS option:selected").val(),
                idEstadoSupervision: $("#slctEstadoCumplimiento option:selected").val()
