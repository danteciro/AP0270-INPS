//especialista/recepcion/recepcion.js
var espeDeriDeri={
...
//            {name: "empresaSupervisada.nroIdentificacion", hidden:true},
        ...
        grid.jqGrid({
            ...
            onRightClickRow: function(rowid) {
                ...
                $('#linkAsignarOSAsig').attr('onClick', 'common.ordenServicio.abrirAsignar("' + rowid + '","gridDerivado")');
            ...
            loadComplete: function(data) {
                ...
                $('#divContextMenuDerivado').html("<ul id='contextMenuDerivado'>"
                        + "<li> <a id='linkAsignarOSAsig' data-icon='ui-icon-person'>Asignar Orden de Servicio</a></li>"
