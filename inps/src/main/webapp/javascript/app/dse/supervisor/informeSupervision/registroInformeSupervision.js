...
var mantenimientoInformeSupervision = {
	...
	abrirAdjuntarInforme : function(numeroExpediente,ruc,idSupervisionRechCarga) {
		$.ajax({
...
jQuery.extend($.fn.fmatter, { 
	 ...
	 formatoInforme : function(cellvalue, options, rowdata) {
			  ...
			  if (idInformedoc == null || idInformedoc == 0){
			    html = '<a href="#" onClick="mantenimientoInformeSupervision.abrirAdjuntarInforme('+rowdata.numeroExpediente+","+ rowdata.ruc+","+ rowdata.idSupervisionRechCarga +');">'+
